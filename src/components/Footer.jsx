...
const Footer = () => {
  ...
  <div className="flex flex-col justify-center items-center gap-8">
    <p className="w-mobile text-center text-2xl sm:text-4xl sm:w-full font-bold">Let's create something that matters!</p>
    ...
    <a className="mb-8 hover:text-gray-700" href="/copyright">Copyright</a>
  </div>
  )
}
